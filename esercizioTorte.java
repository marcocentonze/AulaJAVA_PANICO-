...
public class esercizioTorte {
        public static void main(String[] args) {
                ...
                // chiedo con input all'utente se vuole fare manuale o automatico o
                // semi-automatico
                System.out.println(
                ...
                if (sceltaCreazioneTorta == 1) {
                        ...
                        System.out.println(
                                        "Scegli il tuo ripieno tra: Crema pasticcera,Marmellata,Nutella,Crema di nocciole");
                        ...
                        // stampo il risultato finale della scelta dell'utente
                        System.out.println("La tua torta buonissima è composta da: " + sceltaBase + ", " + sceltaRipieno
                                        + ", " + sceltaFrutta + ", " + sceltaDecorazione + ".");
                        // altrimenti se è automatico uso il random per tutti gli input
                } else if (sceltaCreazioneTorta == 2) {
                        System.out.println("Hai scelto la modalità automatica,contento/a?");
                        sceltaTorta.nextLine();
                        ...
                        // stampo il risultato finale della scelta completamente random
                        System.out.println("La tua combinazione di torta casuale è: " + base[baseAutomatico] + ", "
                                        + ripieno[ripienoAutomatico] + ", " + frutta[fruttaAutomatico] + ", "
                                        + decorazione[decorazioneAutomatico] + ".");
                        // altrimenti se è semi-automatico faccio 2 manuale e 2 automatico
                } else if (sceltaCreazioneTorta == 3) {
                        System.out.println(
                                        "Hai scelto la modalità semi-manuale.Potrai scegliere 2 manualmente e 2 saranno assegnati random.Contento/a?");
                        sceltaTorta.nextLine();
                        System.out.println(
                                        "Scegli la tua base tra: Pan di Spagna,Biscotto,Pasta frolla,Pasta sfoglia.");
                        // sceltaTorta.nextLine();
                        ...
                        System.out.println("La tua torta sarà composta da:" + sceltaBaseSemiAutomatica
                                        + "," + sceltaRipienoSemiAutomatica + ","
